...
st.write('   ')
st.header('Profile: ')  
#st.subheader('Machine Learning Engineer (Skilled in MLOps); Software Solution Developer & Trainer in Data Science (using Python, Machine Learning, SQL) & Python'), Google AppSheet Mobile Apps Developer & Trainer, BI and Analytics with Looker Studio
st.subheader('Machine Learning (AI) Engineer, Data Scientist; Google AppSheet Mobile Apps Developer & Trainer; Software Solution Developer, SQL, Data Modeling expert & Trainer, BI and Analytics with Looker Studio')
...
resume = "https://drive.google.com/file/d/1pId07Ds2lHNVayC9uWAhb-MXdT_eM8FM/view?usp=sharing"
