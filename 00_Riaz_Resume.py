...
st.subheader('Machine Learning (AI) Engineer, Data Scientist; Google AppSheet Mobile Apps Developer & Trainer; Software Solution Developer, SQL, Data Modeling expert & Trainer'), Google AppSheet Mobile Apps Developer & Trainer, BI and Analytics with Looker Studio
